...
function ProductList() {
    ...
    const handleAddToCart = (plant) => {
        ...
        setAddedProducts([...addedProducts, plant.name]); // Add product to addedProducts state
    };
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, idx) => (
                                    <div key={idx} className="product-card">
                                        ...
                                        <button
                                            className={`product-button ${addedProducts.includes(plant.name) ? 'added-to-cart' : ''}`}
                                            onClick={() => handleAddToCart(plant)}
                                            disabled={addedProducts.includes(plant.name)}
                                        >
                                            {addedProducts.includes(plant.name) ? 'Added to Cart' : 'Add to Cart'}
                                        </button>
                                    </div>
                                ))}
                            </div>
